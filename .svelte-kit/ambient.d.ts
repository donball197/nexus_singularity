...
declare module '$env/static/private' {
	...
	export const SYSTEM_BEHAVIOR: string;
	...
	export const EDGE_AGENT_MODEL: string;
	export const RAYON_NUM_THREADS: string;
	export const OLDPWD: string;
	export const NVM_BIN: string;
	export const npm_package_json: string;
	export const NVM_INC: string;
	export const ORT_INCLUDE_LOCATION: string;
	export const NODE_TYPE: string;
	export const PS1: string;
	export const MANAGERPID: string;
	export const SPECIALIST_MODEL: string;
	...
	export const COMMANDER_MODEL: string;
	...
	export const ONNX_ROOT: string;
	export const NCURSES_NO_UTF8_ACS: string;
	export const TERM: string;
	export const npm_config_cache: string;
	export const ORT_LIB_LOCATION: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		HOME: string;
		EDGE_AGENT_MODEL: string;
		RAYON_NUM_THREADS: string;
		OLDPWD: string;
		NVM_BIN: string;
		npm_package_json: string;
		NVM_INC: string;
		ORT_INCLUDE_LOCATION: string;
		NODE_TYPE: string;
		PS1: string;
		MANAGERPID: string;
